...
### Security
`Nmap` · `Burp Suite` · `Wireshark` · `Metasploit` · `Gobuster` · `ffuf` · `BloodHound` · `Impacket` · `NetExec` · `Responder` · `Hashcat` · `John the Ripper` · `SQLMap` · `Nikto`
